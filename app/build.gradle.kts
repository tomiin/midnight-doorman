...
android {
    namespace = "io.github.tomiin.doorman"
    compileSdk = 36

    defaultConfig {
        applicationId = "io.github.tomiin.doorman"
...
kuiraContract {
    ...
    // di/PasskeyConfigModule.kt — a drift between the two is exactly the
    // RP_ID_MISMATCH trap the check exists to catch.
    rpId.set("tomiin.github.io")
